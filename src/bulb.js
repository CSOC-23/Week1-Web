...
function lightSwitch() {
    if(document.getElementById("bulb").src="https://i.postimg.cc/KjK1wL3c/bulb-off.png"){
        bulb_on();
    }
    else if(document.getElementById("bulb").src="https://i.postimg.cc/6QyTynzr/bulb-on.png"){
        bulb_off();
    }
}
