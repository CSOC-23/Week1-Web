...
*/
const bulbstatus=document.querySelector('#flexSwitchCheckChecked');
...
*/
function bulb_on() {
    var bulbom=document.getElementById('bulb');
...
*/
function bulb_off() {
    var bulbof=document.getElementById('bulb');
